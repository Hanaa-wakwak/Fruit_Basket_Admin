...
import 'package:grocery_admin/models/add_product_model.dart';
...
import 'package:grocery_admin/ui/home/products/add_category.dart';
...
class AddProduct extends StatefulWidget {
  ...
  static create(BuildContext context, {Product product}) {
                    ...
                    children: [
                        ...
                        child: StreamBuilder<List<Category>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return DropdownButton<String>(
                              ...
                              underline: SizedBox(),
                              hint: Texts.text(
                                  widget.model.category ?? "Shop Name",
                                  themeModel.textColor),
                              onChanged: (value) {
                      ...
                      AnimatedSize(
                        ...
                        child: (!widget.model.validCategory)
                            ? FadeIn(
                                child: Texts.helperText(
                                    'Please choose a shop name', Colors.red),
                              )
                            : SizedBox(),
                      ),
                    ],
