...
import 'package:grocery_admin/models/add_shipping_model.dart';
...
class _AddShippingState extends State<AddShipping> with TickerProviderStateMixin{
      ...
      child: Wrap(
        children: [
          ...
          AnimatedSize(
            duration: Duration(milliseconds: 300),
            vsync: this,
            child: (!widget.model.validDuration) ? FadeIn(
              child: Texts.helperText('Please enter a valid duration', Colors.red),
            ) : SizedBox(),
          ),
          ...
          AnimatedSize(
            duration: Duration(milliseconds: 300),
            vsync: this,
            child: (!widget.model.validPrice) ? FadeIn(
              child: Texts.helperText('Please enter a valid price', Colors.red),
            ) : SizedBox(),
          ),
