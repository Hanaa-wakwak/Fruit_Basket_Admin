...
class Dialogs{
          ...
          children: [
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Texts.headline3(message, themeModel.textColor,alignment: TextAlign.center),
              ),
            ),

            Align(
              alignment: Alignment.center,
              child: Buttons.button(widget: Texts.headline3('OK', Colors.white), function: (){
  ...
  static Widget error(BuildContext context,{@required List<String> messages}){
    final themeModel=Provider.of<ThemeModel>(context,listen: false);
            ...
            Padding(padding: EdgeInsets.only(
              ...
              child: Column(
                ...
                children: List.generate(messages.length, (index){
                  return Texts.headline3(messages[index], themeModel.textColor);
